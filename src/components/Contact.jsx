            ...
            <div className="container lg:grid lg:grid-cols-2 lg:items-stretch">
                ...
                <div className="mb-12 lg:mb-0 lg:flex lg:flex-col">
                    ...
                    <p className="text-zinc-400 mt-3 mb-8 max-w-[50ch] lg:max-w-[30ch] reveal-up">
                        Comuníquese hoy mismo para analizar las necesidades de su proyecto
                        ¡y comience a colaborar en algo increíble!
                    </p>
                    ...
                    <div className="flex items-center gap-2 mt-auto">
                        {socialLinks.map(({href, icon}, key )=>(
                            ...
                            href={href}
                            target="_blank"
                            className="w-12 h-12 grid place-items-center ring-inset ring-2 riong-zinc-50/5 
                ...
                <form 
                action="https://getform.io/f/adrrxqla"
                method="POST" 
